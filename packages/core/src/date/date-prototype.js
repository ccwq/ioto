...
;(function () {
        ...
        create: function (date) {
            ...
            switch (a.length) {
                case 1:
                    ...
                    return NaN;
                case 2:
                    return new Date(a[0], a[1], 1);
                case 3:
                    return new Date(a[0], a[1], a[2]);
                case 4:
                    return new Date(a[0], a[1], a[2], a[3]);
                case 5:
                    return new Date(a[0], a[1], a[2], a[3], a[4]);
                case 6:
    ...
    Date.Timer.prototype.stop = function (unit, template) {
        ...
        switch (String(unit).toLowerCase()) {
            ...
            case 'minutes':
            case 'minute':
                return usec / 60000000;
            case 'hours':
            case 'hour':
                return usec / 3600000000;
            case 'days':
            case 'day':
                return usec / (24 * 3600000000);
        }
    };
