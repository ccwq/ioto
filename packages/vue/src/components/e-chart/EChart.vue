...
// 所有的鼠标事件
const MOUSE_EVENT_LIST =  ['click','dblclick','mousedown','mousemove','mouseup','mouseover','mouseout','globalout','contextmenu']
...
onMounted(()=>{
    ...
    MOUSE_EVENT_LIST.forEach((eventName)=>{
        const propEventName = "chart" + firstLetterUppercase(eventName) as (typeof MOUSE_EVENT_LIST)[number];
